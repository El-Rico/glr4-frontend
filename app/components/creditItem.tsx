...
export default function CreditItem({
  ...
  return (
    <div className="mb-4 flex items-center justify-between rounded-md border border-solid border-gray-300 bg-white p-3 pr-4 align-middle">
      <div className="flex items-center gap-4">
        <div className="box-border rounded bg-green-600 p-2 text-center text-2xl font-semibold uppercase text-white">
          <svg
            width="32"
            height="32"
            viewBox="0 0 15 15"
        ...
        <div className="text-lg font-bold">Je hebt {credit} credit(s)</div>
      </div>
      {showButton && (
        <Link
          to={`use-credit/`}
          className="block rounded bg-sky-600 px-3 py-2 font-bold text-white hover:bg-gray-700"
        >
          Extra les plannen
        </Link>
      )}
