...
export default function CreditItem({
	...
	return (
		<div className="p-3 pr-4 rounded-md bg-white border border-gray-300 border-solid mb-4 flex justify-between align-middle items-center">
			<div className="flex items-center gap-4">
				<div className="text-2xl uppercase font-semibold rounded bg-green-600 text-white text-center p-2 box-border">
					<svg
						width="32"
						height="32"
						viewBox="0 0 15 15"
